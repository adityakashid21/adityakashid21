...
<p align="center">
  ...
  <a href="https://github.com/your-handle"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"/></a>
...
**Mobile Application Engineer Intern** — *Mathionix Technologies* (Remote) · Jan 2026 – Present

- Owned the end-to-end lifecycle of **4 production-ready mobile apps** simultaneously, from architecture to Play Store deployment.
- Engineered modular TypeScript component libraries for React Native, reducing rendering lag and maximizing cross-device UI fluidity.
...
A high-traffic football networking ecosystem with live production adoption in Algeria.
...
An interactive mock-interview and resume-building platform for a US-based client.
...
- 🏆 **Hack With Gujarat 2025** — Finalist in a state-level 36-hour hackathon, prototyping real-time scalable solutions under crunch time.
